...
dot product between p and the estimate is calculated. The mean and standard
deviation of this angular error is calculated over all <numGoalVectors>
different p, and returned. 
%}
function [m,sd] = meanStdevDotProductError(n,numGoalVectors,D)
